        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {bags.map((bag, index) => {
            ...
            return (
              <div 
                key={bag.id} 
                className="card card-hover p-6 stagger-item flex flex-col justify-between overflow-hidden"
              ...
              >
                ...
                <div className="flex gap-2 pt-4 border-t" style={{ borderColor: 'var(--color-neutral-100)' }}>
                  <Link
                    to={`/bags/${bag.id}/edit`}
                    className="btn btn-secondary btn-sm flex-1 hidden sm:flex justify-center"
                  >
                  ...
                  <button
                    ...
                    className="btn btn-outline btn-sm flex-1 hover:bg-primary-100"
                  >
                    <svg className="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                    </svg>
                    <span className="hidden sm:inline ml-1.5">Clone</span>
                  </button>
                  <button
